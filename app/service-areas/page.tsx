...
export const metadata: Metadata = {
  title: 'Service Areas Near Ayodhya | Vedic Heritage | Free Delivery 25km',
  description:
    'Vedic Heritage delivers cattle feed, havan samagri & puja products across Ayodhya, Faizabad, Bikapur, Sohawal and 15+ villages. Free delivery within 25km.',
...
const WA = `https://wa.me/919999999999?text=${encodeURIComponent('नमस्ते! मुझे अपने क्षेत्र में delivery की जानकारी चाहिए।')}`;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-7">
            <a
              ...
              className="inline-flex items-center gap-2 bg-deepGreen hover:bg-deepGreen/90 text-white font-semibold px-6 py-3 rounded-xl shadow-md transition-all text-sm"
            >
